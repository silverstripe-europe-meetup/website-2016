...
class Page_Controller extends ContentController {
	...
	public function init() {
		...
		Requirements::combine_files('main.js', [
			...
			PROJECT_THIRDPARTY_DIR . '/composer-bower/jquery.browser/jquery.browser.js',
			...
			PROJECT_THIRDPARTY_DIR . '/composer-bower/slick-carousel/slick/slick.min.js',
			PROJECT_THIRDPARTY_DIR . '/composer-bower/sticky-state/dist/stickystate.min.js',
		...
		Requirements::combine_files('main.css', [
			...
			PROJECT_THIRDPARTY_DIR . '/composer-bower/slick-carousel/slick/slick.css',
